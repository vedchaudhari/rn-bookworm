...
export default function UserProfilePage() {
    ...
    useEffect(() => {
        ...
        const fetchProfile = async () => {
            try {
                ...
                setPosts(userPosts);
                setFollowStatus(p.isFollowing ? "following" : p.hasRequestedFollow ? "requested" : "none");
            } catch {
    ...
    const handleFollow = async () => {
        ...
        try {
            ...
            if (status === "following") setFollowStatus("following");
                ...
                <div className="flex items-end justify-between -mt-10 mb-4">
                    <div className="relative w-20 h-20 rounded-full overflow-hidden"
                        ...
                        {profile.profileImage ? (
                            <Image src={profile.profileImage} alt={profile.username} fill className="object-cover" unoptimized />
                        ) : (
