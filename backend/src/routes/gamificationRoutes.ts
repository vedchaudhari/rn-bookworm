...
router.get("/achievements", protectRoute, async (req: Request, res: Response) => {
    try {
...
// Get leaderboard
router.get("/leaderboard", protectRoute, async (req: Request, res: Response) => {
    try {
...
// Create reading goal
router.post("/goal", protectRoute, async (req: Request, res: Response) => {
    try {
        const { targetBooks, period, endDate } = req.body as CreateGoalBody;
        const userId = req.user!._id;
...
router.get("/goals", protectRoute, async (req: Request, res: Response) => {
    try {
        const userId = req.user!._id;
        const status = req.query.status as string; // active, completed, failed, or all
...
router.put("/goal/:goalId", protectRoute, async (req: Request, res: Response) => {
    try {
...
// Get user statistics
router.get("/stats", protectRoute, async (req: Request, res: Response) => {
    try {
        const userId = req.user!._id;
...
router.post("/update-streak", protectRoute, async (req: Request, res: Response) => {
    try {
        const userId = req.user!._id;
