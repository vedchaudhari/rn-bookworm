import { View, Text, ScrollView, TouchableOpacity, FlatList, ActivityIndicator, RefreshControl, Dimensions, Alert, StyleSheet } from 'react-native';
...
export default function UserProfile() {
        ...
        try {
            ...
            if (!result.canceled && result.assets[0].base64) {
                ...
                const response = await fetch(`${API_URL}/api/users/update-profile-image`, {
                    ...
                    body: JSON.stringify({ profileImage: base64Img })
                });
    ...
    const handleMessage = () => {
        router.push({ pathname: '/chat', params: { userId, username: user?.username } });
    };
